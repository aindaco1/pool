...
export function localizationReviewMarkdown(evidence) {
  const lines = [
    '# Pool Localization Review Packet',
    '',
    `Generated: ${evidence.generatedAt}`,
    `Locales: ${(evidence.reviewLocales || []).join(', ') || 'none'}`,
    '',
    '> This packet validates source coverage and the review workflow. It does not claim professional or native-speaker approval.',
    '',
