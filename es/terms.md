...
- Las administradoras de plataforma pueden usar el panel para gestionar configuración de campañas, ajustes de plataforma, complementos, enlaces de referencia, borradores compartidos de marketing y personas usuarias autorizadas del panel. Los valores secretos se mantienen en almacenes de secretos de despliegue o archivos locales ignorados, no en contenido de campaña ni en borradores del panel.
