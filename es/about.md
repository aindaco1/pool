...
El hito de lanzamiento actual de la plataforma es **v1.0.8**. El conjunto de funciones de v1.0 y el endurecimiento de lanzamiento ya están completos, y la versión más reciente añade endurecimiento de runtime derivado de Store, lecturas de Marketing diferidas y autenticadas, contexto recordado de tabs/subtabs del panel y comprobaciones más fuertes de completitud de locales.
...
- **Espacio de trabajo recordado en el panel**: cuando una persona administradora recarga el panel, el navegador puede volver a su último tab permitido, sección de Settings, campaña seleccionada y subtab de Campaigns sin guardar ese estado de UI en datos del Worker.
