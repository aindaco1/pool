...
Email changes follow the [Ethical Risk review](./ETHICAL_RISK.md) when they add new audiences, triggers, reminders, reports, or marketing surfaces.
...
[Customization](CUSTOMIZATION.md) for routine fork configuration.
