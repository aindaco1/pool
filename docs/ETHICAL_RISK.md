...
- Performance and prefetching: start from [PERFORMANCE.md](./PERFORMANCE.md). Speculative loading stays public-only and does not pressure user action or background private flows.
