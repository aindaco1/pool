...
The v1.0 feature set and release-hardening pass are complete. v1.0.1 adds actual Stripe fee/net capture for analytics, dashboard media optimization tooling, and the latest merge-gate verification. Remaining unstarted work lives under **Future Features** unless a critical launch regression is found.
