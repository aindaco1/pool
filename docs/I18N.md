...
- structured locale config in [`_config.yml`](../_config.yml)
...
The canonical locale config lives in [`_config.yml`](../_config.yml):
...
- [about.md](../about.md)
- [es/about.md](../es/about.md)
- [terms.md](../terms.md)
- [es/terms.md](../es/terms.md)
- [creator-campaign-checklist.md](../creator-campaign-checklist.md)
...
- [worker/src/email.js](../worker/src/email.js)
...
2. Add the language to the `i18n` block in [/_config.yml](../_config.yml).
...
Automated locale completeness and rendered i18n/SEO checks remain release gates. A native-Spanish review packet is generated on schedule, but human/native-speaker review is optional evidence for v1.1.0 and must not be claimed unless it actually occurred. Require an explicit translator/native-speaker review plan before adding locales beyond English and Spanish.
