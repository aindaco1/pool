...
The current platform release milestone is **v1.0.0 release candidate**. The v1.0 feature set is in place, with final launch hardening focused on admin sign-in bot protection and release smoke verification.
