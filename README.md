...
Current release branch milestone: **v1.2.7**. Pool pins immutable `dust-wave-platform` `v0.19.0` and consumes bounded shared Worker logging and site-media catalog mechanics through thin campaign-policy adapters while retaining logging policy, campaign content, transforms, storage, provider, deployment, and rollback authority.
