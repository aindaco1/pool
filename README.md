...
Current release milestone: **v1.0.8**. The v1.0.7 release shipped abandoned-checkout visibility, setup/deploy hardening, shared Marketing/Blast draft support, referral/UTM reporting, and a campaign-scoped WYSIWYG media picker. v1.0.8 focuses on Store-derived runtime hardening, lazy authenticated Marketing reads, remembered admin dashboard tab/subtab context, and stronger locale completeness checks.
