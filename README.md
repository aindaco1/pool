...
Current release branch milestone: **v1.2.2**. This release advances Pool to the immutable `dust-wave-platform` `v0.15.0` workspace and consumes its characterized HTTP/security, timezone, Stripe transport, and deterministic release primitives while preserving Pool's deployment, data, pledge, payment, and business-rule boundaries.
