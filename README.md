...
Current release branch milestone: **v1.2.13**. Pool pins immutable `dust-wave-platform` `v0.26.0` and consumes its framework-neutral browser-test setup and mobile overflow assertion through tiny Vitest/Playwright adapters. Pool retains fixtures, pages, viewports, product assertions, CI, deployment, and one-commit rollback authority.
