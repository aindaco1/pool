...
Current release branch milestone: **v1.2.1**. This release advances Pool to the immutable `dust-wave-platform` `v0.12.0` workspace while preserving Pool's deployment, data, pledge, payment, and business-rule boundaries.
