  ...
  beforeEach(() => {
    ...
    document.head.innerHTML = `
      <script
        ...
        data-cart-cache-key="pool_cart_cache"
        data-cart-provider-global="PoolCartProvider"
        data-cart-provider-ready-event="poolcart.provider.ready"
        data-cart-ready-event="poolcart.ready">
      </script>
    `;
  });
