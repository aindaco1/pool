...
describe('SEO templates', () => {
  ...
  it('marks private pledge and supporter layouts as noindex', () => {
    ...
    expect(manageLayout).toContain('{% include form-control-identity-script.html asset_version=asset_version %}');
    expect(communityLayout).toContain('indexable=false');
    expect(communityLayout).toContain('{% include form-control-identity-script.html %}');
    expect(pledgeResultLayout).toContain('indexable=false');
    expect(adminLayout).toContain('indexable=false');
    expect(adminLayout).toContain('{% include form-control-identity-script.html asset_version=asset_version %}');
