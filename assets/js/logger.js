(function() {
  ...
  var GLOBAL_HANDLER_KEY = '__poolLoggerGlobalHandlersInstalled';
  ...
  function getInlineConfig() {
    var script = document.currentScript || document.querySelector('script[data-pool-logger-script]');
  ...
  function getConfig() {
    ...
    var poolConfig = window.POOL_CONFIG || {};
    var debugConfig = poolConfig.debug || {};
  ...
  function emit(level, namespace, args) {
    ...
    var timestamp = '[Pool ' + formatTimestamp() + ']';
    var scope = namespace ? '[Pool:' + namespace + ']' : '[Pool]';
